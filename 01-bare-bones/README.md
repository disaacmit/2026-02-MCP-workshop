...
### Step 3: Scaffold the MCP server with STDIO transport

[TypeScript SDK docs](https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md)
...
[https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md#tools](https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md#tools)
...
[https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md#resources](https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md#resources)
...
### Step 6: Register a prompt

[https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md#prompts](https://github.com/modelcontextprotocol/typescript-sdk/blob/v1.x/docs/server.md#prompts)
